...
<?php 
 ...
 $sql_day =    "SELECT r.reserve_id,m.emp_id,m.name_lastname,m.dep_name,r.date_reserve,r.time_checkin
...
<title>Daily report</title>
  ...
  <script>
   ...
   <script>
    ...
    <div align = "center">
      <form name="form1"  style="width:400px" action="report_day.php" method="GET">
          <h3>&nbsp;</h3>
    ...
    <div class="container">
     <div class="btn-toolbar-left" >
      <a href="report_day.php?start_date=<?php echo $start; ?>&end_date=<?php echo $end; ?>"> 
          <button class="btn btn-primary">Check-in</button></a>
