...
if(isset($_GET['date_check'])){
  $start_date_check = $_GET['start'];
  $end_date_check = $_GET['end'];
}

header("Content-Type: application/vnd.ms-excel");
header('Content-Disposition: attachment; filename="Reserve_month.xls"');#ชื่อไฟล์ 



// mysqli_select_db($database_connect, $connect);
$query_BookingLists = " SELECT r.emp_id,m.name_lastname,m.dep_name,m.tel,m.email,
                               r.date_reserve,r.time_reserve,r.time_checkin,r.time_cancel,
                               r.remark,r.account_reserve,r.account_check
...
<table width="100%" cellspacing="0" cellpadding="0" border="1">
  <tr>
    ...
    <td><div align="center">date_reserve</div></td>
    <td><div align="center">time_reserve</div></td>
    <td><div align="center">account_reserve</div></td>
