...
<?php 
 ...
 $sql_day = "SELECT r.reserve_id,m.emp_id,m.name_lastname,m.dep_name,r.date_reserve,r.no_id,r.time_cancel,r.status,r.remark
...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <div align = "center">
      <form name="form1"  style="width:400px" action="day_cancel.php" method="GET">
          <h3>&nbsp;</h3>
